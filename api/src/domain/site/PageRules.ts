...
export const SECCIONES: Record<string, readonly string[]> = {
  ...
  //
  // `image` y `research_areas` son dos bandas distintas, y en este orden: primero lo que
  // investiga sobre el claro del hero, y despues la ilustracion sola sobre el solido.
  home: ['hero', 'research_areas', 'image', 'latest_news'],
  research: ['header'],
